...
function MenuDashboard() {
    return (
        <div className="bg-slate-800 light:bg-amber-100 dark:bg-neutral-800 dark:border-b-1 dark:border-cyan-400 dracula:bg-dracula-700 lg:rounded-b-xl xl:mt-1 lg:mb-10 xl:mb-0 xl:rounded-xl pt-1 pb-2 xl:mx-2 lg:flex  lg:justify-center xl:block lg:gap-15 lg:max-w-[900px] lg:mx-auto">
            <div className="mx-2 my-2 lg:justify-center lg:items-center xl:block xl:border-b-1 border-slate-600 dark:border-neutral-600 light:border-amber-200">
                ...
                <ul className="flex flex-col xl:gap-3 lg:gap-1 justify-center text-gray-300 light:text-gray-600">
                    <Link to={'/mangas'}>
                        <l1 className="flex py-1 px-2 2xl:mr-4 items-center rounded-sm hover:bg-slate-700 light:hover:bg-amber-50 dracula:hover:bg-dracula-600 dark:hover:bg-neutral-700 cursor-pointer">
                    ...
                    <Link to={'/mangas?filter=Todos-los mangas'}>
                        <l1 className="flex py-1 px-2 2xl:mr-4 hover:bg-slate-700 light:hover:bg-amber-50 dracula:hover:bg-dracula-600 dark:hover:bg-neutral-700 items-center rounded-sm cursor-pointer">
                    ...
                    <l1 className="flex py-1 px-2 2xl:mr-4 hover:bg-slate-700 light:hover:bg-amber-50 dracula:hover:bg-dracula-600 dark:hover:bg-neutral-700 items-center rounded-sm mb-2 cursor-pointer">
            ...
            <div className="mx-2 my-2 xl:border-b-1 border-slate-600 dark:border-neutral-600 light:border-amber-200">
                ...
                <ul className="flex flex-col xl:gap-3 lg:gap-1 justify-center text-gray-300 light:text-gray-600">
                    ...
                    <l1 className="flex py-1 px-2 2xl:mr-4 items-center rounded-sm hover:bg-slate-700 light:hover:bg-amber-50 dracula:hover:bg-dracula-600 dark:hover:bg-neutral-700 cursor-pointer mb-2">
